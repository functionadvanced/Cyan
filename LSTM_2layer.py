...
class LSTMpredictor(torch.nn.Module):
    def __init__(self, hidden_dim):
        ...
        self.min_note = 40
        self.lstm = torch.nn.LSTM(2, hidden_dim, num_layers=2)
    ...
    def loadModel(self):
        ...
        savedModel_name = "LSTM_2layer.model"
    ...
    def predictFromOne(self, LEN, seed, start_note, start_time, start_hid1, start_hid2, min_time):
        ...
        self.hidden = (torch.rand(2, 1, self.hidden_dim) *start_hid1,
                        torch.rand(2, 1, self.hidden_dim) * start_hid2)
        with torch.no_grad():
            for ii in range(LEN):                                
                re = self.forward(re)
